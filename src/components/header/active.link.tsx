...
import { usePathname } from "next/navigation"; // usePathname is a hook now imported from navigation// chỉ dùng ở client được
...
const ActiveLink = ({
  ...
  const isActive = pathName.startsWith(href as string); // lấy pathname bắt đầu bằng
  return (
